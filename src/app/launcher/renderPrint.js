...
const BOOKLET_STYLE = `
  <style>
    ...
    @media(max-width:760px){.booklet-reader__book{min-height:620px}.booklet-reader__frame{width:100%}.booklet-reader__link{grid-template-columns:1fr}.booklet-reader__cover{padding:24px}.booklet-reader__controls button{flex:1 1 auto}.booklet-reader__overlay-slots{inset:56px 24px;grid-template-columns:1fr;gap:18px}.booklet-reader__overlay-slot[data-label='right page frame']{display:none}}
  ...
  return `
    <section class="print-tabletop clean-comic-launcher booklet-reader" data-comic-stage data-print-stage data-booklet-reader aria-label="Museum Multiverse Lost Pages booklet reader">
      ...
      <main class="print-tabletop__layout booklet-reader__frame" aria-label="One-page flipbook reader">
        ...
        <div class="booklet-reader__book" data-page-frame-stage>
          <div class="booklet-reader__frame-viewport" data-page-frame-viewport aria-hidden="true"></div>
          <div class="booklet-reader__overlay-slots" data-page-frame-overlay aria-hidden="true">
            <div class="booklet-reader__overlay-slot" data-page-frame-slot="left" data-label="left page frame"></div>
            <div class="booklet-reader__overlay-slot" data-page-frame-slot="right" data-label="right page frame"></div>
          </div>
