...
const BOOKLET_STYLE = `
  <style>
    ...
    .booklet-reader__intro{position:fixed;inset:0;z-index:4;display:grid;place-items:center;padding:24px;background:linear-gradient(145deg,rgba(27,18,10,.92),rgba(9,6,4,.86));transition:opacity .38s ease,visibility .38s ease;will-change:opacity}.booklet-reader[data-open='true'] .booklet-reader__intro{opacity:0;visibility:hidden;pointer-events:none}.booklet-reader__title-card{width:min(680px,100%);border:2px solid rgba(247,239,222,.28);border-radius:0;padding:clamp(28px,6vw,60px);background:linear-gradient(145deg,rgba(58,39,22,.9),rgba(26,18,12,.92));box-shadow:0 32px 90px rgba(0,0,0,.38);text-align:center}.booklet-reader__title-card h1{margin:0;font-family:'Cormorant Garamond',serif;font-size:clamp(3.2rem,12vw,7.6rem);line-height:.82}.booklet-reader__seal{margin:0 0 18px;font-weight:900;letter-spacing:.22em;text-transform:uppercase;color:rgba(247,239,222,.68)}
    ...
    <section class="print-tabletop clean-comic-launcher booklet-reader" data-comic-stage data-print-stage data-booklet-reader aria-label="Museum Multiverse Lost Pages booklet reader">
      ...
      <div class="booklet-reader__intro" data-booklet-intro>
        <div class="booklet-reader__title-card">
          ...
          <p class="clean-comic-hero__copy">A recovered flipbook. Open the sharp paper cover, then reveal the pages vertically.</p>
